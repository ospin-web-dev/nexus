...
describe('create Process Stream Image', () => {
  ...
  it('should show an error message when the file could not be found', async () => {
    await expect(nexus.deviceAPI.process.stream.image.createFromFile(
  ...
  describe('on failure', () => {
    ...
    it('should throw an error', async () => {
      ...
      await expect(nexus.deviceAPI.process.stream.image.createFromFile(processId, streamId, body))
